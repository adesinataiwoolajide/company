            ...
            <div class="dahboard-header-area d-sm-flex align-items-center justify-content-between">
                ...
                <div class="dahsboard-header-link">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{route('project.category.edit',$cate->category_id)}}"><i class="fa fa-pencil"></i> EDIT PROJECT CATEGORY</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <p>Please fill the below form to update theproject category </p>
                            @include('partials._message')
                            <form action="{{route('project.category.update',$cate->category_id)}}" method="POST" enccategory="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
