            ...
            <div class="dahboard-header-area d-sm-flex align-items-center justify-content-between">
                ...
                <div class="dahsboard-header-link">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{route('project.type.edit',$typo->type_id)}}"><i class="fa fa-pencil"></i>EDIT PROJECT TYPES</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <p>Please fill the below form to update project type </p>
                            @include('partials._message')
                            <form action="{{route('project.type.update',$typo->type_id)}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control form-control-rounded" id=""
                                        placeholder="Enter The Project Type Name" required name="type_name" value="{{$typo->type_name}}">
                                    ...
                                    <input type="hidden" name="prev_name" value="{{$typo->name}}">

                                    <div class="form-group col-md-4">
                                        <button type="submit" class="btn btn-rounded btn-outline-primary btn-block" name="">UPDATE THE PROJECT TYPE</button>
                                    </div>
                                </div>
                            </form>
                        </div>
